...
def rules():
    ...
    cprint(
        'When entering your name, you can write whatever you want, ' +
        'but it should only consist of letters.\n', 'blue'
    )
    cprint(
...
def team_malmo_story(player_name):
    ...
    effect.slow(
        ...
        f"After four seasons with Malmö, {player_name} gets recruited by:\n"
    )
...
def team_goteborg_story(player_name):
    ...
    effect.slow(
        ...
        f"However, after three seasons, Göteborg needs to sell {player_name} \n"
...
def youth_coach_story(player_name):
    ...
    """
    effect.slow(
        f"\n{player_name} starts their coaching career with the hometown club\n"
...
def team_milan_story(player_name):
    ...
    effect.slow(
        ...
        "and even wins the leauge one year.\n"
...
def coach_story(player_name):
    ...
    effect.slow(
        ...
        f"After six seasons with Sirius, {player_name} becomes the\n"
...
def junior_coach_story(player_name):
    ...
    """
    effect.slow(
        f"\n{player_name} is asked to help with Elfsborg's junior team,\n"
...
def team_lissabon_story(player_name):
    ...
    effect.slow(
        ...
        "Sporting Lissabon even wins the Europa League one year.\n"
    )
